...
private ["_tracer_object_name","_xx","_yy","_zz","_dir","_obj_tras","_poc_mic","_nr_tracer","_li_tracer","_life_time_tras_lum","_range_trace","_colorred","_colorgreen","_colorblue","_ro","_ve","_bl","_life_time_tras","_activation_distance"];
